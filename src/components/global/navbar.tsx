...
const Navbar = async  (props:Props) => {
  return (
    <header className="fixed dark:text-white text-neutral-800 right-0 left-0 top-0 py-4 px-4 bg-black/40 backdrop-blur-lg z-[100] flex items-center border-b-[1px] border-neutral-900 justify-between">
